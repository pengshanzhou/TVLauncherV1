...
public final class Launcher extends Activity
    ...
    public void onClickPrevScreenButton(View view) {
        ...
        int nextPage = Math.max(0, currentPage - 1);
        if (nextPage != currentPage) {
            mWorkspace.snapToPage(nextPage);
            // MY BUG:If fast click, no react. Guess is animation not done
        } else {
    ...
    */
    ...
    private void setupViews() {
        ...
        // Eazy way to do: enlarge arrow icon!!
        ...
        if (isClingsEnabled() && !prefs.getBoolean(Cling.WORKSPACE_CLING_DISMISSED_KEY, false)) {
            ...
            //if(ClientName.equals("ds5")){
                ...
                try{
			        ...
			        wpm.setResource(R.drawable.wallpaper_u1a);
				}catch(Exception e){
				}
			}
        } else {
